    ...
    <>
      <div className={styles.details}>
        ...
        <div className={styles["users-reactions"]}>
          ...
          />
          <ButtonInline to="/event/1/comments" text="Show all" arrow={true} />
        </div>
      </div>
      <EventFooter
        to="/event/1/booking"
        visibleText="Book now"
        invisibleText="Only 5 tickets left"
        heading="You can buy thickets for this event here !"
      />
    </>
  );
};
